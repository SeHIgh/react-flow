...
const initialNodes: Node[] = [
  ...
  },
  {
    ...
    data: {
      ...
      metrics: { memory: 45, connections: 234 },
    },
  ...
  },
  {
    ...
    data: {
      ...
      metrics: { cpu: 89, memory: 76, connections: 387 },
    },
...
const initialEdges: Edge[] = [
  ...
  { id: "e2", source: "cdn", target: "load-balancer", label: "Cache Miss" },
  {
    id: "e3",
  ...
  { id: "e9", source: "api-gateway", target: "redis", label: "Cache" },
  { id: "e10", source: "api-gateway", target: "database", label: "Queries" },
  { id: "e11", source: "api-gateway", target: "monitoring", label: "Metrics" },
];
